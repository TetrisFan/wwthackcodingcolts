    ...
    <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
      <main role="main" class="container mt-4">
        <div class="jumbotron d-flex flex-column align-items-center text-center">
          <div class="w-75 d-flex flex-column align-items-center">
            ...
            <div class="collapse w-100 mt-3" id="editDesc">
              <form class = "form-signin" method="post" action="club-profile-superuser.php">
        ...
        <div class="modal fade" id="remove-member" role="dialog">
          ...
          <div class="btn btn-primary mt-5 mb-1" style="background-color: #111753;" data-toggle="modal" data-target="#confirm-leave">Archive Club</div>
