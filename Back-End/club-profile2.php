...
$result = mysqli_query($conn, "SELECT ClubID, ClubName, ClubDescription FROM club WHERE ClubName =  '".$clubName."'") or die(mysqli_error($conn));
      ...
      <main role="main" class="container mt-5">
        <div class="jumbotron d-flex flex-column align-items-center text-center">
          <div class="w-75 d-flex flex-column align-items-center">
            ...
            <form action="club-profile2.php" method='post'>
